 ...
 *
 * The savable_state_dhuff subrecord contains fields that change within an MCU,
...
typedef struct {
  ...
  savable_state_dhuff saved;		/* Other state at start of MCU */
