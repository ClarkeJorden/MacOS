 ...
 *
 * The savable_state_chuff subrecord contains fields that change within an MCU,
...
typedef struct {
  ...
  savable_state_chuff saved;		/* Bit buffer & DC state at start of MCU */
...
typedef struct {
  ...
  savable_state_chuff cur;		/* Current bit buffer & DC state */
