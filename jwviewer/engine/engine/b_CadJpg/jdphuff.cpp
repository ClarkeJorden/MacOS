 ...
 *
 * The savable_state_dphuff subrecord contains fields that change within an MCU,
...
typedef struct {
  ...
  savable_state_dphuff saved;		/* Other state at start of MCU */
